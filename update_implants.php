...
if (isset($_POST['submit'])) {
  ...
  $get_id=$_POST['get_id'];
      ...
      $q="UPDATE `implants` SET `type`='$type',`puissance`='$puissance',`marque`='$marque',`fournisseur_id`='$fournisseur_id',`qte`='$qte',`seuil_min`='$seuil_min',`prix_a`='$prix_a',`prix_v`='$prix_v' WHERE `id`='$get_id'";
      //echo $q;exit();
      $r=mysqli_query($dbc,$q);
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 mb-4" style="color: #5f1411">Modifier implant</h1>
                <?php
                if (isset($msg)) {
                ?>
              ...
              ?>
              <form class="user" action="update_implants.php?id=<?= $get_id ?>" method="post">
                ...
                <div class="form-group">
                  <!-- <label>Puissance - Dioptrique</label> -->
                    <input type="number" class="form-control form-control-user" value="<?= $row['puissance'] ?>" name="puissance" required>
                </div>
                <div class="form-group">
                  <!-- <label>Marque</label> -->
