...
if (isset($_POST['submit'])) {
  ...
  $prix_v=$_POST['prix_v'];
      ...
      $q="INSERT INTO `produit_entre`(`article`, `marque`, `fournisseur_id`, `qte`, `seuil_min`, `prix_a`, `prix_v`) VALUES ('$article', '$marque', '$fournisseur_id', '$qte', '$seuil_min', '$prix_a', '$prix_v')";
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 mb-4" style="color: #5f1411">Créer une nouvelle facture</h1>
                <?php
                if (isset($msg)) {
                ?>
              ...
              <form class="user" action="add_fact.php" method="post">
                <a href="add_c.php">Ajouter un nouveau client</a>
                <div class="form-group">
                  <label for="sel1">Client</label>
                  <select class="form-control" id="sel1" name="c_id" required>
                    <option></option>
                    <?php
