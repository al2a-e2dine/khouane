...
if (isset($_POST['submit'])) {
  ...
  $net_profit=$prix_v-$prix_a;
      ...
      $q="INSERT INTO `implants`(`type`, `puissance`, `marque`, `fournisseur_id`, `qte`, `seuil_min`, `prix_a`, `prix_v`, `net_profit`) VALUES ('$type', '$puissance', '$marque', '$fournisseur_id', '$qte', '$seuil_min', '$prix_a', '$prix_v', '$net_profit')";
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 mb-4" style="color: #5f1411">Ajouter implants</h1>
                <?php
                if (isset($msg)) {
                ?>
              ...
              <form class="user" action="add_implant.php" method="post">
                ...
                <div class="form-group">
                  <!-- <label>Puissance - Dioptrique</label> -->
                    <input type="number" class="form-control form-control-user" placeholder="Puissance - Dioptrique" name="puissance" required>
                </div>
                <div class="form-group">
                  <!-- <label>Marque</label> -->
