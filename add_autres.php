...
if (isset($_POST['submit'])) {
  ...
  $net_profit=$prix_v-$prix_a;
      ...
      $q="INSERT INTO `other`(`designation`, `fournisseur_id`, `qte`, `seuil_min`, `prix_a`, `prix_v`, `net_profit`) VALUES ('$designation', '$fournisseur_id', '$qte', '$seuil_min', '$prix_a', '$prix_v', '$net_profit')";
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 mb-4" style="color: #5f1411">Ajouter autres</h1>
                <?php
                if (isset($msg)) {
                ?>
              ...
              <form class="user" action="add_autres.php" method="post">
                <div class="form-group">
                  <!-- <label>Désignation</label> -->
                    <input type="text" class="form-control form-control-user" placeholder="Désignation" name="designation" required>
                </div>
                <div class="form-group">
